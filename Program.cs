...
namespace Assignment2_DIS_Spring2021
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            string testString = "ockry";
            int[] indices = { 1, 2, 3, 0, 4 };
            RestoreString(testString, indices);
            ...
            int[,] scores = { { 1, 100 }, { 7, 100 }, { 1, 100 }, { 7, 100 }, { 1, 100 }, { 7, 100 }, { 1, 100 }, { 7, 100 }, { 1, 100 }, { 7, 100 } };
            HighFive(scores);
            Console.WriteLine();
        ...
        private static void RestoreString(string testString, int[] indices)
        {
            try
            {
                char[] ToChar = testString.ToCharArray();                                                           // To store characters of the input string in a Char array
